  ...
  return (
    <div style={{
      ...
      <div style={{ borderBottom: '1px solid var(--border)', paddingBottom: '16px' }}>
        <div style={{ fontSize: '13px', color: 'var(--accent)', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px' }}>
          The Daily Briefer
        </div>
        <h2 style={{ margin: 0, fontSize: '24px', fontWeight: '800', lineHeight: 1.2, color: 'var(--text)' }}>
