  ...
  function renderTrialPaywall() {
    app.innerHTML = `<div class="screen onboarding active"><div class="onboard-step ob-trial-wall">
      ...
      <div class="ob-pw-timeline">
        ...
        <div class="ob-tl-point locked"><div class="ob-tl-dot">${I('lock-closed-outline')}</div><div class="ob-tl-label">Day 7</div><div class="ob-tl-sub">Billed $39.99</div></div>
      </div>
      ...
      <div class="ob-pw-price">Free for 7 days, then<br/><span class="ob-pw-amount">$39.99/year</span>  ($3.33/month)</div>
      <button class="ob-pw-cta" id="ob-trial-start">Start your FREE week—no payment now</button>
      <button class="ob-pw-alt" id="ob-trial-monthly">or $7.99/month</button>
    ...
    <div id="paywall-overlay" class="paywall-overlay">
      ...
      <div class="paywall-content">
        ...
        <div class="paywall-pricing">
          <div class="pricing-option" data-plan="monthly"><div class="pricing-period">Monthly</div><div class="pricing-amount">$7.99</div><div class="pricing-sub">/month</div></div>
          <div class="pricing-option selected" data-plan="annual"><span class="save-badge">Save 58%</span><div class="pricing-period">Annual</div><div class="pricing-amount">$39.99</div><div class="pricing-sub">$3.33/month</div></div>
        </div>
